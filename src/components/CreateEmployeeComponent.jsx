...
class CreateEmployeeComponent extends Component {
    ...
    componentDidMount(){
        ...
        if(this.state.id === '_add'){
            ...
            EmployeeService.getEmployeeById(this.state.id).then( (res) =>{
                ...
                this.setState({nombre: employee.nombre,
    ...
    saveOrUpdateEmployee = (e) => {
        e.preventDefault();
        let employee = {nombre: this.state.nombre, apellidos: this.state.apellidos, edad: this.state.edad};
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveOrUpdateEmployee}>Agregar</button>
